...
class UserRegisterForm(forms.Form):
    ...
    password = forms.CharField(required=True, min_length=3, max_length=16, error_messages={
        'required': '密码必须填写',
        'min_length': '密码至少3位',
...
class UserRegsetForm(forms.Form):
    ...
    password2 = forms.CharField(required=True, min_length=3, max_length=16, error_messages={
        'required': '密码必须填写',
        'min_length': '密码至少3位',
        'max_length': '密码不能超过16位',
    })
